		...
		<div class="container container1">
			...
			<picture class="catItem">
				...
				<figure>
					...
					<br>約<?php echo $catRow->CAT_NO;?>月份出生
					<br>性別:<?
                                if ($catRow->CAT_SEX == 1) {
                            ...
                            ?>
					<br>個性:<?echo $catRow->CAT_NARRATIVE?>
					<br>毛色:<?echo $catRow->CAT_COLOR?>
					<br>地區:<?echo $catRow->CAT_LOCATION?>
					<br>疫苗:<?
            ...
            echo "訊息: ",$e->getMessage() , "<br>";
                            ...
                            ?>
					<div class="btn">
						<button class="defaultBtn">我要領養</button>
