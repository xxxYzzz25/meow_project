...
VALUES
	(1, 'Friskies 雞肉罐頭', 56, 'BEST!全方位寵物營養專家,專門替亞熱帶地區寵物特別研發出全方位營養寵物飼料。 \n遵照 NRC、AAFCO、FEDIAF 為標準製作， 並技術指導製造商使用高規格機器， 在全程電腦精準計算食材數量控制， 及人員嚴格品質把關的低溫烘培下， 將食材營養牢牢鎖在飼料中，讓養分完全保留不流失， BEST！系列絕不潻加人工香料、荷爾蒙、防腐劑、化學添加物、動物副產品！ 冠全生技用心、用愛來生產寵物飼料， 讓每位飼主的愛心可藉由優良寵物飼料傳遞給寵物。 因此特別與「財團法人動物研究所動物產業組」合作定期進行飼料批量病毒檢驗。 \n', 0, '100g (± 5%)', '紐西蘭', '粗蛋白質 30%、粗脂肪 10%、粗纖維 4%、水分 11%', NULL, NULL, 1),
	(2, 'Whiskas 美味飼料', 300, '高達78%的新鮮肉類及魚類蛋白質，不含穀類，減少過敏原。22%的蔬果精華及多種滋補草本植物能抗氧化。高達8種益生菌及益菌生，照顧腸胃並幫助吸收。添加葡萄糖胺及軟骨素，維護關節健康及發展。富含Omega3&6不飽和脂肪酸，有效對抗發炎、護膚亮毛。', 0, '1kg', '美國', '蛋白質、碳水化合物、維生素、礦物質、Omega Oil', NULL, NULL, 1),
	(3, 'Whiskas 雞肉口味飼料', 320, '動物性蛋白質80%符合貓生理需求 ，黴菌毒素吸附劑有效吸附腸道害菌 ，牛磺酸安定貓神經維持視覺的功能 ，菸鹼酸加入減少貓咪下痢消瘦可能 ，特殊胺基酸保護腎臟平衡尿液酸鹼', 0, '1kg', '美國', '扁豆、鷹嘴豆、蛋、乾燥啤酒酵母、天然香料', NULL, NULL, 1),
	(4, 'FancyFeast 鮪魚大餐', 2000, '高優質全天然雞肉蛋白質，最容易消化吸收。不含玉米，小麥，黃豆成份，低便量低便臭。高含量亞麻酸，有效護膚亮毛。豐富蔬果精華，提升抗氧化強化免疫力。濃縮蔓越莓精華，維護泌尿道健康。', 0, '13kg', '澳洲', '濃縮雞肉、豌豆、雞脂肪、濃縮白身魚肉、濃縮牛肉，木薯澱粉', NULL, NULL, 1);
