...
INSERT INTO `PRODUCT` (`PRODUCT_NO`, `PRODUCT_NAME`, `PRODUCT_PRICE`, `PRODUCT_NARRATIVE`, `PRODUCT_STATUS`, `PRODUCT_WEIGHT`, `PRODUCT_LOC`, `PRODUCT_COMPONENT`, `PRODUCT_SIZE`, `PRODUCT_MATERIAL`, `PRODUCT_PART`)
VALUES
	(1, 'Friskies 雞肉罐頭', 49, 'BEST!全方位寵物營養專家,專門替亞熱帶地區寵物特別研發出全方位營養寵物飼料。 \n遵照 NRC、AAFCO、FEDIAF 為標準製作， 並技術指導製造商使用高規格機器， 在全程電腦精準計算食材數量控制， 及人員嚴格品質把關的低溫烘培下， 將食材營養牢牢鎖在飼料中，讓養分完全保留不流失， BEST！系列絕不潻加人工香料、荷爾蒙、防腐劑、化學添加物、動物副產品！ 冠全生技用心、用愛來生產寵物飼料， 讓每位飼主的愛心可藉由優良寵物飼料傳遞給寵物。 因此特別與「財團法人動物研究所動物產業組」合作定期進行飼料批量病毒檢驗。 \n', 0, '100g (± 5%)', '紐西蘭', '粗蛋白質 30%、粗脂肪 10%、粗纖維 4%、水分 11%', NULL, NULL, 1),
	(2, 'Whiskas 美味飼料', 239, '高達78%的新鮮肉類及魚類蛋白質，不含穀類，減少過敏原。22%的蔬果精華及多種滋補草本植物能抗氧化。高達8種益生菌及益菌生，照顧腸胃並幫助吸收。添加葡萄糖胺及軟骨素，維護關節健康及發展。富含Omega3&6不飽和脂肪酸，有效對抗發炎、護膚亮毛。', 0, '1kg', '美國', '蛋白質、碳水化合物、維生素、礦物質、Omega Oil', NULL, NULL, 1),
	(3, 'Whiskas 雞肉口味飼料', 889, '動物性蛋白質80%符合貓生理需求 ，黴菌毒素吸附劑有效吸附腸道害菌 ，牛磺酸安定貓神經維持視覺的功能 ，菸鹼酸加入減少貓咪下痢消瘦可能 ，特殊胺基酸保護腎臟平衡尿液酸鹼', 0, '7kg', '美國', '扁豆、鷹嘴豆、蛋、乾燥啤酒酵母、天然香料', NULL, NULL, 1),
	(4, 'FancyFeast 鮪魚大餐', 250, '高優質全天然雞肉蛋白質，最容易消化吸收。不含玉米，小麥，黃豆成份，低便量低便臭。高含量亞麻酸，有效護膚亮毛。豐富蔬果精華，提升抗氧化強化免疫力。濃縮蔓越莓精華，維護泌尿道健康。', 0, '1.2kg', '澳洲', '濃縮雞肉、豌豆、雞脂肪、濃縮白身魚肉、濃縮牛肉，木薯澱粉', NULL, NULL, 1),
	(5, 'PETS 防濺貓便盆', 1680, '有效防止貓砂飛濺，便於整理，篩網取用便利好清洗，上蓋側邊落砂網設計，多種顏色可選，每款附一同色貓鏟', 0, NULL, '台灣', NULL, '91 x 65 x 6cm', '聚脂纖維', 2),
	(6, 'Ppark 貓抓板', 390, '台灣製造品質可靠安心耐用。強化集層紙板貼合而成，堅固紮實，耐磨損，耐用度是一般瓦楞紙的四倍。可減少80%的紙塵產生。貓咪磨爪最佳良器，精緻收編設計，耐抓耐咬耐磨損。', 0, NULL, '日本', NULL, '35 x 22 x 7.5 cm', '瓦楞紙', 2),
	(7, 'Nourish 貓砂', 499, '輕如羽毛, 吸水力強如海棉，難以置信的除臭效果，100% 貓咪實測證實效果佳，可沖馬桶並容易清理，特殊的豆腐顆粒纖維讓每顆立方體表面有10幾萬個細微毛孔, 讓貓砂有著超強吸水力及高除臭效果', 0, '10kg', '台灣', '豆腐 , 玉米澱粉, 檸檬酸', NULL, NULL, 2),
	(8, 'Kiki 潔毛手套', 249, '五指靈活設計，穿脫方便。輕輕一摸，帶走多餘雜毛，輕鬆徹底清潔寵物雜毛 ，矽膠材質柔軟舒適，不傷害寵物的肌膚，可增進與寵物的感情', 0, '72g', '中國', NULL, '17 x 24 x 1 cm', '橡膠', 2),
	(9, 'Petstages 貓草罐', 180, '延長貓草香味最棒的補充包，內含100% 天然優質貓草，適量灑在玩具上，可以有效引起貓咪的興趣，優質的貓薄荷香味是貓咪最愛的味道，降低貓咪的無聊感，能減少不必要的破壞行為發生', 0, '14g', '美國', '貓草粉', NULL, NULL, 3),
	(10, 'PetBest 有機貓薄荷草', 198, 'PetBest 百憂解有機貓薄荷草，鐵罐吸濕密封蓋包裝，有機栽培的薄荷草，無農藥無添加人工物經冷風乾燥製作，精選A級品葉，香氣養份不流失，常保鮮綠。食用薄荷貓草，可舒解貓咪情緒，增進食慾，並可幫助貓咪腸胃蠕動，促進腸胃的健康，排出毛球', 0, '20g', '日本', '薄荷、貓草粉', NULL, NULL, 3),
	(11, 'GimCat 貓草膏', 300, '貓草膏是便利的貓草替代品，以精選高級貓草提煉而成，內含豐富的葉綠素，營養源，能補充貓咪所需能量。 高纖維質能幫助貓咪排出毛球整腸助消化。 可穩定貓兒情緒', 0, '50g', '德國', '甘草、油、脂肪、維生素E', NULL, NULL, 3),
	(12, 'PetBest 絕對貓草錠', 160, '內含豐富的天然 (荊芥內脂、麝香) 等化合物能舒緩愛貓心情，減輕壓力與焦躁。純天然的植物纖維，幫助愛貓排除體內毛球，助消化、維護腸道健康。經打錠製成更保有其香氣，增加刺激與興奮的作用，愛貓會躺於地上左右打滾、流口水，如同酒醉般地發出愉悅的咕咕聲', 0, '30錠入 (每錠500mg)', '日本', '鐵、硒、鉀、錳、鉛、維生素、礦物質、葉綠素', NULL, NULL, 3),
	(13, 'PETMATE 雷射逗貓棒', 880, '雙重玩法，將雷射筆套在手指頭上，若隱若現的雷射光可讓喵星人享受野生捕獵的感受。此外，逗貓棒附帶金屬釣線，釣線前頭的掛鉤可掛上傑克森—羽毛系列。將逗貓棒舉高並晃動可激起喵星人高空獵捕的動力，亦可增進與寵物間的情感。逗貓棒為可收進口袋設計，方便攜帶不佔空間。遊戲可幫助情緒安定、減少日常生活累積的壓力與不開心，陪伴喵星人無聊的時間', 0, NULL, '中國', NULL, '46 x 4 x 1 cm', '塑膠、金屬', 4),
	(14, 'PET DREAM 抓老鼠轉盤', 320, '圓盤式設計，由底盤、彈簧桿、毛絨老鼠、貓爪墊組成。玩具頂部為貓抓板的設計，可以讓貓咪抓抓抓，磨爪子。玩具圓盤裝置內放置的玩具鼠，輕輕一碰就會圍著圓盤轉圈', 0, NULL, '中國', NULL, '直徑 25 cm，高 6.5 cm', '環保塑料、絨毛', 4),
	(15, 'Migo 貓咪蹭毛器', 455, '本產品採用的是高級毛刷，硬度適中，一般貓咪都適用，如果貓咪是從外面玩耍回家，您可以把產品放到門口，讓貓咪在刷門裡來回的走動，這樣就不怕貓咪把髒東西帶回家了。貓咪身上癢的時候可以拿出來，刷子可拆開另外清洗，在貓咪玩耍的同時還可以幫助清潔貓咪身上的髒東西，真是一舉兩得', 0, NULL, '台灣', NULL, '36 x 28.5 x 34 cm', '不銹鐵、高度地毯布', 4),
	(16, 'iCat 三角貓咪隧道', 790, '偷偷潛入、或者隱藏、或者玩躲貓貓。小小的迷宮，隧道有四個口，將引起貓咪挑戰的心情，也可減輕貓咪的身心壓力。收納簡單，折圓壓扁即可快速收納，重量超輕巧，任何人皆可收放自如，並且不佔空間。不僅耐抓，也方便清洗', 0, NULL, '日本', NULL, '直徑 25 cm、長 50 cm', '聚酯、聚酯、聚丙烯、鋼鐵、橡膠', 4);
...
VALUES
	(1, 1, '喵航航', 0, 0, '活潑親人', '2017/09', 1, '黑白', 1, '../images/catPic/Sara@gmail.com1.jpg', '新北市', '親人、溫和', '初養貓者', '很懂得珍惜', '剛換環境會有點小緊張'),
	(2, 1, '喵芽芽', 0, 1, '活潑親人', '2017/09', 1, '虎斑', 1, '../images/catPic/Sara@gmail.com2.jpg', '新北市', '親人、溫和', '初養貓者', '很盡責，有陣子貓區只剩他一隻貓，他會很盡力的滿足全場客人想摸摸的慾望', '剛換環境會有點小緊張'),
	(3, 1, '喵蝦米', 0, 0, '活潑親人', '2017/01', 1, '橘白', 1, '../images/catPic/Sara@gmail.com3.jpg', '新北市', '親人、溫和', '初養貓者', '很懂得珍惜', '剛換環境會有點小緊張'),
	(4, 1, '喵大眼', 0, 1, '撒嬌親人', '2015', 1, '橘白', 1, '../images/catPic/Sara@gmail.com4.jpg', '新北市', '親人、傲嬌', '初養貓者', '親人，有個性', '剛換環境會有點小緊張'),
	(5, 1, '喵兵兵', 0, 1, '混新加坡貓', '2016/10', 1, '虎斑', 1, '../images/catPic/Sara@gmail.com5.jpg', '新北市', '親熟人、有個性、陌生人接近會哈氣作勢，但其實不會攻擊人', '有養過貓的人', '認人，只愛熟人', '慢熟、緊張'),
	(6, 1, '喵皮皮', 0, 0, '超級親人活拍外放', '2017/05', 1, '黑白', 1, '../images/catPic/Sara@gmail.com6.jpg', '新北市', '親人、活潑', '初養貓者', '活潑愛玩很有趣', '不知輕重'),
	...
	(9, 2, '喵絲絲', 0, 1, '橘白貓', '2017/03', 1, '橘白', 1, '../images/catPic/Handsome@gmail.com9.jpg', '台北市', '親人、愛玩', '初養貓者', '親人、愛玩', '有點兒調皮'),
	...
	(12, 2, '喵航航', 0, 0, '活潑親人', '2017/09', 1, '黑白', 1, '../images/catPic/Handsome@gmail.com12.jpg', '台北市', '親人、溫和', '初養貓者', '很懂得珍惜', '剛換環境會有點小緊張'),
	(13, 3, '喵芽芽', 0, 1, '活潑親人', '2017/09', 1, '虎斑', 1, '../images/catPic/Silvia@gmail.com13.jpg', '新北市', '親人、溫和', '初養貓者', '很盡責，有陣子貓區只剩他一隻貓，他會很盡力的滿足全場客人想摸摸的慾望', '剛換環境會有點小緊張'),
	(14, 3, '喵蝦米', 0, 0, '活潑親人', '2017/01', 1, '橘白', 1, '../images/catPic/Silvia@gmail.com14.jpg', '新北市', '親人、溫和', '初養貓者', '很懂得珍惜', '剛換環境會有點小緊張'),
	(15, 3, '喵大眼', 0, 1, '撒嬌親人', '2015', 1, '橘白', 1, '../images/catPic/Silvia@gmail.com15.jpg', '新北市', '親人、傲嬌', '初養貓者', '親人，有個性', '剛換環境會有點小緊張'),
	(16, 3, '喵兵兵', 0, 1, '混新加坡貓', '2016/10', 1, '虎斑', 1, '../images/catPic/Silvia@gmail.com16.jpg', '新北市', '親熟人、有個性、陌生人接近會哈氣作勢，但其實不會攻擊人', '有養過貓的人', '認人，只愛熟人', '慢熟、緊張'),
	(17, 3, '喵皮皮', 0, 0, '超級親人活拍外放', '2017/05', 1, '黑白', 1, '../images/catPic/Silvia@gmail.com17.jpg', '新北市', '親人、活潑', '初養貓者', '活潑愛玩很有趣', '不知輕重'),
	(18, 3, '喵追風', 0, 0, '長得像反派老大...', '2015', 1, '橘', 1, '../images/catPic/Silvia@gmail.com18.jpg', '新北市', '非常親人，人怎麼弄他都不會生氣', '初養貓者', '已經長大了很好照顧、很親人、對人脾氣很好', '長得像壞蛋...看起來好像很兇..但是這不是真的');
