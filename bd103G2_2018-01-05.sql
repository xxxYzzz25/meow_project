...
CREATE TABLE `ARTICLE_PIC` (
  ...
  `ARTICLE_PIC_PATH` varchar(40) NOT NULL DEFAULT '',
...
CREATE TABLE `CAT_PIC` (
  ...
  `CAT_PIC_PATH` varchar(40) NOT NULL DEFAULT '',
...
CREATE TABLE `HALF_PIC` (
  ...
  `HALF_NO` int(5) NOT NULL,
  `HALF_PIC_PATH` varchar(40) NOT NULL DEFAULT '',
...
CREATE TABLE `PRODUCT_PIC` (
  ...
  `PRODUCT_NO` int(10) NOT NULL,
  `PRODUCT_PIC_PATH` varchar(40) NOT NULL DEFAULT '',
