...
VALUES
	...
	(14, 'DREAM 抓老鼠轉盤', 320, '圓盤式設計，由底盤、彈簧桿、毛絨老鼠、貓爪墊組成。玩具頂部為貓抓板的設計，可以讓貓咪抓抓抓，磨爪子。玩具圓盤裝置內放置的玩具鼠，輕輕一碰就會圍著圓盤轉圈', 0, NULL, '中國', NULL, '直徑 25 cm，高 6.5 cm', '環保塑料、絨毛', 4, '../images/productPic/14.jpg'),
	...
	(22, 'GreenL DIY貓草', 170, '有機栽培的薄荷草，無農藥無添加人工物經冷風乾燥製作，精選A級品葉，香氣養份不流失，常保鮮綠。食用薄荷貓草，可舒解貓咪情緒，增進食慾，並可幫助貓咪腸胃蠕動，促進腸胃的健康，排出毛球', 0, NULL, '日本', '燕麥、栽培用土', '12cm * 21.5cm * 6cm', '', 3, '../images/productPic/21.jpg'),
	(23, 'QIAA 老鼠洞玩具', 326, '偷偷潛入、或者隱藏、或者玩躲貓貓。小小的迷宮，隧道有四個口，將引起貓咪挑戰的心情，也可減輕貓咪的身心壓力。收納簡單，重量超輕巧，任何人皆可收放自如，並且不佔空間。不僅耐抓，也方便清洗', 0, '0.13 kg', '', '', '31cm*31cm*12cm', '尼龍布、鋼絲', 4, '../images/productPic/22.jpg'),
	(24, 'SnapCat 橘魚逗貓棒', 240, '利用「幫浦」的概念，設計出令人都動搖的尾巴，讓貓奴變身為貓的王者。擁有專利的逗貓玩具，左跳又跳的毛球一定會讓家中的貓咪玩瘋！不同於以往的逗貓棒，每款都藏有迷你幫浦，透過主人按壓手中的打 氣球，尾端的毛球就會活生生地跳動！不同繽紛的可愛動物造型，快來看看哪一款式最適合家中的貓咪！', 0, '', '日本', '', '3cm x 9cm x 53cm', '聚酯、聚酯、聚丙烯、鋼鐵、橡膠', 4, '../images/productPic/23.jpg');
...
VALUES
	(1, 5, '喵拉拉', 2, 1, '活潑、親人、不怕生', '2017/09', 0, '虎斑', 0, '../images/catPic/gan@gmail.com2.jpg', '台中市', '活潑、親人、不怕生', '養貓新手', '超撒嬌、黏人、非常呼嚕', '愛討摸、貪吃'),
	...
	(7, 2, '喵追風', 0, 0, '長得像反派老大...', '2015/02', 1, '虎斑', 1, '../images/catPic/Handsome@gmail.com7.jpg', '台北市', '非常親人，人怎麼弄他都不會生氣', '初養貓者', '已經長大了很好照顧、很親人、對人脾氣很好', '長得像壞蛋...看起來好像很兇..但是這不是真的'),
	...
	(12, 4, '喵羅丹', 0, 0, '乖巧、內向', '2016/08', 1, '橘白', 1, '../images/catPic/rain@gmail.com0.jpg', '屏東縣', '到新環境易緊張、需耐心對待、乖巧、內向、不搗蛋、熟悉後才愛撒嬌、安靜、內斂', '養貓新手', '乖巧、內向', '易緊張'),
	...
	(19, 5, '喵拉拉', 0, 1, '活潑、親人、不怕生', '2017/09', 0, '虎斑', 0, '../images/catPic/gan@gmail.com2.jpg', '台中市', '活潑、親人、不怕生', '養貓新手', '超撒嬌、黏人、非常呼嚕', '愛討摸、貪吃'),
	...
	(22, 1, '喵大眼', 0, 1, '撒嬌親人', '2015/01', 1, '虎斑', 1, '../images/catPic/Sara@gmail.com4.jpg', '新北市', '親人、傲嬌', '初養貓者', '親人，有個性', '剛換環境會有點小緊張'),
